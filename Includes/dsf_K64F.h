...
typedef enum { dsf_GPIOA = 0, dsf_GPIOB, dsf_GPIOC, dsf_GPIOD, dsf_GPIOE,
               ...
               dsf_UART0, dsf_UART1, dsf_UART2, dsf_UART3, dsf_USB0TG } OCP_t;
...
typedef enum { dsf_PTA1 = 0, dsf_PTA2, dsf_PTA4, dsf_PTA5, dsf_PTA12, dsf_PTA13, dsf_PTA16, dsf_PTA17,
               ...
               dsf_SDA_PTD5, dsf_RESET_PTA20, dsf_PORTB, dsf_PORTC } Pin_t;

/**/
typedef enum { dsf_Ok = 0, dsf_OverWriteError, dsf_ParityError, dsf_TimeOutError } Exception_t;
